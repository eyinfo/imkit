...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private static class Ring {
        ...
        public void draw(Canvas c, Rect bounds) {
            ...
            c.drawCircle(bounds.exactCenterX(), bounds.exactCenterY(), (float) bounds.width() / 2, mCirclePaint);
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(int shadowRadius, int circleDiameter) {
            ...
            RadialGradient mRadialGradient = new RadialGradient((float) mCircleDiameter / 2, (float) mCircleDiameter / 2,
        ...
        public void draw(Canvas canvas, Paint paint) {
            ...
            canvas.drawCircle((float) viewWidth / 2, (float) viewHeight / 2, ((float) mCircleDiameter / 2 + mShadowRadius),
                    mShadowPaint);
            canvas.drawCircle((float) viewWidth / 2, (float) viewHeight / 2, ((float) mCircleDiameter / 2), paint);
        }
    }
}