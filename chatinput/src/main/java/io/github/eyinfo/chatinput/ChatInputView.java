package io.github.eyinfo.chatinput;
...
import io.github.eyinfo.chatinput.camera.CameraNew;
import io.github.eyinfo.chatinput.camera.CameraSupport;
import io.github.eyinfo.chatinput.emoji.Constants;
import io.github.eyinfo.chatinput.emoji.EmojiBean;
import io.github.eyinfo.chatinput.emoji.EmojiView;
import io.github.eyinfo.chatinput.emoji.EmoticonsKeyboardUtils;
import io.github.eyinfo.chatinput.emoji.data.EmoticonEntity;
import io.github.eyinfo.chatinput.emoji.listener.EmoticonClickListener;
import io.github.eyinfo.chatinput.emoji.widget.EmoticonsEditText;
import io.github.eyinfo.chatinput.listener.CameraControllerListener;
...
import io.github.eyinfo.chatinput.photo.SelectPhotoView;
import io.github.eyinfo.chatinput.record.ProgressButton;
import io.github.eyinfo.chatinput.record.RecordControllerView;
import io.github.eyinfo.chatinput.record.RecordVoiceButton;
import io.github.eyinfo.chatinput.utils.SimpleCommonUtils;
...
public class ChatInputView extends LinearLayout
    ...
    private void init(Context context) {
        ...
        mPhotoBtn = findViewById(R.id.aurora_menuitem_ib_photo);
        mCameraBtn = findViewById(R.id.aurora_menuitem_ib_camera);
        ...
        mSendAudioBtn = findViewById(R.id.aurora_btn_recordvoice_send);
        mCancelSendAudioBtn = findViewById(R.id.aurora_btn_recordvoice_cancel);
    ...
    private OnClickListener onMenuItemClickListener = new OnClickListener() {
        ...
        public void onClick(View view) {
            if (view.getId() == R.id.aurora_menuitem_ib_send) {
                ...
                if (mSelectPhotoView.getSelectFiles() != null && !mSelectPhotoView.getSelectFiles().isEmpty()) {
