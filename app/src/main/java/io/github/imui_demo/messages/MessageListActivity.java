...
import io.github.eyinfo.messages.messages.ViewHolderController;
import io.github.eyinfo.messages.messages.ptr.PtrHandler;
import io.github.eyinfo.messages.messages.ptr.PullToRefreshLayout;
import io.github.imui_demo.R;
import io.github.imui_demo.models.DefaultUser;
import io.github.imui_demo.models.MyMessage;
import io.github.imui_demo.views.ChatView;
        ...
        ImageLoader imageLoader = new ImageLoader() {
            ...
            public void loadAvatarImage(ImageView avatarImageView, String string) {
                ...
                if (string.contains("R.drawable")) {
                    ...
                    Glide.with(MessageListActivity.this)
                            .load(string)
                            .apply(new RequestOptions().placeholder(io.github.eyinfo.messages.R.drawable.aurora_headicon_default))
            ...
            public void loadImage(final ImageView imageView, String string) {
                ...
                Glide.with(getApplicationContext())
                        .asBitmap()
                        .load(string)
                        .apply(new RequestOptions().fitCenter().placeholder(io.github.eyinfo.messages.R.drawable.aurora_picture_not_found))
